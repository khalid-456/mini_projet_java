package tp3ex5;
	...
	System.out.println("Entrer le debit maximal autorisé du compte");
	...
	System.out.println("Le montant entré est négatif ou nul !");
	}
	}
	...
	this.soldeCompte -= montant;
		...
		System.out.println("Vous avez dépasser le découvert maximal");
		}
		}else{
		System.out.println("Le montant entré est négatif ou nul !");
		}
